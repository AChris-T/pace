...
const HeroSection = () => {
  ...
  return (
    ...
    <div className='flex flex-col justify-center mt-[-80px] '>
        <div  data-aos="fade-up" className='flex flex-wrap  md:px-0 px-2 items-center justify-center text-center  lg:justify-center md:flex-nowrap'>
            <h2 className='flex lg:text-[64px] md:text-[55px] text-[45px] font-normal text-white myFont'>Play</h2>
            <div className='w-2 h-2 md:mt-9 mt-4 mr-2 bg-white'></div>
            <h2 className='flex lg:text-[64px] md:text-[55px] text-[45px] font-normal myFont text-white'>
            Learn</h2>
            <div className='w-2 h-2 mr-3 bg-white md:mt-9  mt-5'></div>
            <h2 className='flex lg:text-[64px] md:text-[55px] text-[45px] font-normal myFont text-white'>
            Earn</h2>
            <div className='w-2 h-2 md:mt-9 mt-5 mr-2 bg-white'></div>
        </div>
