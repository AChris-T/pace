...
const Register = () => {
  return (
    <div className="flex flex-col gap-8 bg-green-Primary_1 rounded-t-[40px] h-[85vh] px-8 py-8 ">
      ...
      <div className="flex flex-col gap-3">
      <label className="text-[#f2f2f2] font-bold text-[16px]">Password</label>
      <input className="bg-transparent border-b-2 outline-none font-normal text-[#FFFFFF]"/>
      </div>
      <div className='relative mt-2 cursor-pointer'>
            <NavLink to="/login" className="absolute  bg-white rounded-[50px] w-full h-[50px] flex justify-center items-center text-green-Primary_1 font-bold leading-[31.2px] text-[18px]">Sign Up</NavLink>
